  ...
  return (
    <div className='p-[3rem] md:px-[4.5rem]'>
        <div className='p-[2rem] text-3xl font-bold'>{loggedInUser?loggedInUser.name:""} <span className='heading-font'>Watch List</span></div>
            {
            <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-3 md:gap-5 max-w-[1200px] md:pt-[3rem] pb-[5rem] min-h-[395px] md:mx-auto'>
